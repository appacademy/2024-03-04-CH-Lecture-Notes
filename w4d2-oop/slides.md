...
![clock](https://i.ibb.co/rQmJTwN/clock.jpg)
...
![clock-innards](https://i.ibb.co/myptzK7/clock-innards.jpg)
...
s = Subclass.new
s.some_method # Will print:
# "in SuperClass#some_method"
# "in SubClass#some_method"
```
...
![chessUML](https://i.ibb.co/cTP0wn9/chess.png)